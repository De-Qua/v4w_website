...
Revision ID: cf5010e0a8c9
Revises: 
Create Date: 2025-10-12 23:30:21.151516
...
def upgrade_data_versions():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('street_graph_id', sa.Integer(), nullable=False),
    sa.Column('waterbus_graph_id', sa.Integer(), nullable=False),
    sa.Column('water_graph_id', sa.Integer(), nullable=False),
    sa.Column('tide_id', sa.Integer(), nullable=False),
