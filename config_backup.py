...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = "postgresql://dequa:vivalafiga@192.168.1.104:5432/opendata_ve_pg"
    SQLALCHEMY_BINDS = {
        # dequa_collected_data has usage, errors, feedback and so on
        "collected_data": 'postgresql://dequa:vivalafiga@192.168.1.104:5432/dequa_collected_data',
        # dequa_config_data has error codes, languages and so on
        "config_data": 'postgresql://dequa:vivalafiga@192.168.1.104:5432/dequa_config_data',
        # dequa_internal has the registered users, the tokens and apis
        "internal": 'postgresql://dequa:vivalafiga@192.168.1.104:5432/dequa_internal'
    }
