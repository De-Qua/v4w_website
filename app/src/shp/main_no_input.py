...
def calculate_path():
    ...
    civico = np.loadtxt(folder_db + "lista_civici_csv.txt", delimiter = ";" ,dtype='str')
    ...
    starting_address = "Dorsoduro 3479" #input('Da dove parti?\n')
    coord = civico2coord_first_result(G_list, starting_address, civico, coords)
    ending_address = "Santa Croce 343" #input('Dove vai?\n')
    coord2 = civico2coord_first_result(G_list, ending_address, civico, coords)
